...
function getStepsAch() {
    return ["General", "Processing", "Finance", "Circulations", "Publications" , "Users" ,"activities", "Training Courses" ];
}
...
function getStepContentAch(stepIndex) {
    switch (stepIndex) {
        case 0:
                        ...
                        <Box>
                            ...
                            <Box mt={4}>
                                {activeStep === steps.length ? (
                                    ...
                                    <Box>
                                        <Typography>{getStepContentAch(activeStep)}</Typography>
                                        <Box pt={2}>
                                            <Button
                                                variant="contained"
                                                color="secondary"
                        ...
                        <Box>
                            <form onSubmit={handleSubmit} encType="multipart/form-data"
                                ...
                                <div className="flex flex-col gap-2">
                                    <h2 className="text-sm">Setup your achievement for year and month :</h2>
                                    <div
