...
import {createGeneralAch, getGeneralAch, updateGeneralAch} from "../../../actions/infrastructureAction";
...
const General  = ({year, month}) => {
    ...
    const {loading, success, general, error} = useSelector((state) => state.infrastructure);
