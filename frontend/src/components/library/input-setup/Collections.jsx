...
const Collections = ({year, month}) => {
    ...
    const toggle = () => {
        setTotal(((children == null) ? 0 : parseInt(children.toString())) +
            ((journalsAndPeriodicals == null) ? 0 : parseInt(journalsAndPeriodicals.toString())) +
            ((electronicResources == null) ? 0 : parseInt(electronicResources.toString())) +
            ((database == null) ? 0 : parseInt(database.toString())) +
            ((digitalCollection == null) ? 0 : parseInt(digitalCollection.toString())) +
            ((digitalRepository3Years == null) ? 0 : parseInt(digitalRepository3Years.toString())) +
            ((totalOfRareMaterialsNeedConservation == null) ? 0 : parseInt(totalOfRareMaterialsNeedConservation.toString())) +
            ((adults == null) ? 0 : parseInt(adults.toString())))
        if (total == null)
            setTotal(0);
        setOpen(!open);
    };
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="flex flex-col sm:flex-row items-center gap-3"
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <React.Fragment>
                                                        {!open && (
                                                            <Button onClick={toggle}>Calculate Total Collections
                                                            </Button>
                                                        )}
                                                        {open && (
                                                            <Container>
